...
class Graph:
    def __init__(self, nodes=None): #sort of irrelevant, since nodes hold their own adjacency
    ...
    def traverse(self, starting_node=None):
        ...
        if not starting_node:
            starting_node = self.nodes.pop() #if no starting node provided, grab one at random
