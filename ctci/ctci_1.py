...
if __name__ == "__main__":
    ...
    print(
        f"Testing is_unique_no_additional_data_structures('')={is_unique_no_additional_data_structures('')}"
    )
    print(
        f"Testing is_unique_no_additional_data_structures('abcd')={is_unique_no_additional_data_structures('abcd')}"
    )
    print(
        f"Testing is_unique_no_additional_data_structures('aba')={is_unique_no_additional_data_structures('aba')}"
    )
    ...
    print("\n\nCTCI 1.4")
    print(
        f"Testing is_anagram_of_palindrome_hashmap('')={is_anagram_of_palindrome_hashmap('')}"
    )
    print(
        f"Testing is_anagram_of_palindrome_hashmap('tactcoa')={is_anagram_of_palindrome_hashmap('tactcoa')}"
    )
    print(
        f"Testing is_anagram_of_palindrome_hashmap('Tact Coa')={is_anagram_of_palindrome_hashmap('Tact Coa')}"
    )
    print("\n\nCTCI 1.6")
